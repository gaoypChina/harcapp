...
class CustomParticleSystem extends ChangeNotifier {
  ...
  Size _randomSize() {
    double aspectRatio = _maximumSize.width/_maximumSize.height;
    double randWidth = Helper.randomize(_minimumSize.width, _maximumSize.width);
    double randHeight = randWidth/aspectRatio;
    return Size(
      randWidth,
      randHeight,
    );
