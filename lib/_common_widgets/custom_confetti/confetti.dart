...
import 'package:harcapp/_common_widgets/custom_confetti/particle.dart';

// To co tutaj zmeniłem to wyłączyłem w linijce 380 obracanie w osi Z.
...
class _CustomConfettiWidgetState extends State<CustomConfettiWidget>
  ...
  late CustomParticleSystem _particleSystem;
  ...
  void initState() {
    ...
    _particleSystem = CustomParticleSystem(
    ...
    return RepaintBoundary(
      child: CustomPaint(
        ...
        foregroundPainter: ParticlePainter(
          ...
          disableFullRotation: widget.disableFullRotation,
        ),
        child: widget.child,
      ),
    );
