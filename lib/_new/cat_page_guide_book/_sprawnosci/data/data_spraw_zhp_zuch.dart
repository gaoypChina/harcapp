          ...
          familyData: [
                ...
                sprawData: [
                  ...
                  SprawData(
                      ...
                      tasks: [
                        ...
                        'Narysowałem(-am) plakat przedstawiający zasłużonego Polaka/zasłużoną Polkę. Pokazałem(-am) plakat w kręgu rady.',
                  ...
                  SprawData(
                      ...
                      tasks: [
                        ...
                        'Narysowałem(-am) plakat przedstawiający dokonania zasłużonego Polaka/zasłużonej Polki. Pokazałem(-am) plakat w kręgu rady.',
                  ...
                  SprawData(
                      ...
                      tasksAreExamples: true,
                      tasks: [
                        'Znam hymn Polski i wiem, w jaki sposób trzeba zachowywać się podczas jego śpiewania. Zaśpiewałem(-am) hymn i opowiedziałem(-am) o tym drużynowemu/drużynowej.',
                        'Odwiedziłem(-am) urząd miasta lub gminy. Wiem, jakie sprawy można tam załatwić.',
            ...
            SprawFamilyData(
                ...
                requirements: [
                  ...
                  'Pomagałem(-am) odrabiać lekcje koledze/koleżance.',
                  'Opowiedziałem(-am) o tym, co się dzieje w szkole lub w gromadzie niepełnosprawnemu koledze/koleżance.',
                  'Nauczyłem(-am) niepełnosprawnego kolegę/koleżankę piosenki, pląsu, gry dostosowanej do jego/jej możliwości.',
                  'Wspólnie z niepełnosprawnym kolegą/koleżanką zorganizowałem(-am) coś dla innych dzieci (turniej, zabawy itp.).',
                  ...
                  'Pomogłem(-am) niepełnosprawnemu koledze/koleżance przyjść na zbiórkę.',
                ...
                sprawData: [
                  ...
                  SprawData(
                      ...
                      tasks: [
                        ...
                        'Pomagałem(-am) odrabiać lekcje koledze/koleżance z niepełnosprawnością.',
                        'Opowiedziałem(-am) o tym, co się dzieje w szkole lub w gromadzie koledze/koleżance z niepełnosprawnością.',
                        'Zrobiłem(-am) coś miłego dla osoby niepełnosprawnej lub starszej.',
                      ]),
                  SprawData(
                      id: 'przyjaciel_nieznanego_swiata',
                      ...
                      tasks: [
                        ...
                        'Nauczyłem(-am) kolegę/koleżankę z niepełnosprawnością piosenki, pląsu, gry dostosowanej do jego/jej możliwości.',
                        'Wspólnie z kolegą/koleżanką z niepełnosprawnością zorganizowałem(-am) coś dla innych dzieci (turniej, zabawy itp.).',
                        'Zrobiłem(-am) coś miłego dla osoby niepełnosprawnej lub starszej.',
                        'Opowiedziałem(-am) o moich kontaktach z osobą niepełnosprawną lub starszą zuchom w gromadzie lub w szóstce.',
                        'Pomogłem(-am) koledze/koleżance z niepełnosprawnością przyjść na zbiórkę.',
                      ]),
                  SprawData(
                      id: 'przyjaciel_nieznanego_swiata',
                      title: 'Przyjaciel Nieznanego Świata',
            ...
            SprawFamilyData(
                ...
                requirements: [
                  ...
                  'Stworzyłem(-am) kodeks lub poradnik „śmieszka/śmieszki”.',
                ],
                notesForLeaders: [
                ...
                sprawData: [
                  ...
                  SprawData(
                      ...
                      tasks: [
                        ...
                        'Przeprowadziłem(-am) w gromadzie konkurs na najładniejszy uśmiech „po cytrynie”.',
                        'Wykonałem(-am) niezauważony(-na) przynajmniej trzy dobre uczynki, które wywołały uśmiech na czyjejś twarzy. Opowiedziałem(-am) o tym na zbiórce.',
                        'Umiem zachować umiar w moich żartach, mam poczucie dobrego smaku, nie drwię z nikogo, nie śmieję się z cudzego nieszczęścia. Wszyscy dobrze czują się w moim towarzystwie. Ułożyłem(-am) kodeks lub poradnik „śmieszka/śmieszki”.',
                        'Brałem(-am) udział w zabawie „Mój mały, biedny, czarny kotku”, w której powstrzymywałem(-am) się od śmiechu.',
                      ]),
                  SprawData(
                      id: 'smieszek',
                      ...
                      tasks: [
                        ...
                        'Zorganizowałem(-am) kabareton w gromadzie. Zaprosiłem(-am) do niego rodziców.',
                        'Umiem zachować umiar w żartach, mam poczucie dobrego smaku, nie drwię z nikogo, nie śmieję się z cudzego nieszczęścia. Wszyscy dobrze czują się w moim towarzystwie. Ułożyłem(-am) kodeks lub poradnik „śmieszka/śmieszki”.',
                        'Brałem(-am) udział w zabawie „Mój mały, biedny, czarny kotku”, w której powstrzymywałem(-am) się od śmiechu.',
                      ]),
                ]
            ),
