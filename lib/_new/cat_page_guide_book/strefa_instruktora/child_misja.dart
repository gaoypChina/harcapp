    ...
    builder: (context) => SelectableText.rich(
      TextSpan(
        ...
        children: <TextSpan>[
          ...
          TextSpan(text: 'Zastęp to grupa przyjaciół, która pozwala na znalezienie swojego miejsca i sprawdzenie się w samodzielnym działaniu. Praca w małych grupach przynosi wymierne efekty wychowawcze, ponieważ łatwiej jest dotrzeć do każdego, dostrzec jego wartość, pomóc mu pokonać słabości, porozmawiać z nim, poznać go. W harcerstwie takie grupy stanowią szóstki, zastępy, patrole, zespoły zadaniowe. Na ich czele stoją zwykle rówieśnicy mający trochę większe doświadczenie czy też wyrobienie harcerskie, cieszący się zaufaniem. We współzawodnictwie konkurowanie ze sobą zespołów wzmaga emocje, zwiększa motywację do działania.'),
        ],
      ),
      textAlign: TextAlign.justify,
    ),
