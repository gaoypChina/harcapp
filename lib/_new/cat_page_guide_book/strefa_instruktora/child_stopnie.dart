    ...
    Widget cardPWD = SimpleButton(
      ...
      onTap: () => showScrollBottomSheet(
        ...
        builder: (context) => BottomSheetStopien(
          ...
          warOtw: ['Złożenie Przyrzeczenia Harcerskiego.',
            'Przedstawienie KSI programu swojej próby zapewniającego realizację wymagań.',
            'Ukończone 16 lat.',
          ],
          zadania: ['Kształtuje własną osobowość zgodnie z Prawem Harcerskim, w tym dokonał samooceny i na tej podstawie ułożył i konsekwentnie realizował plan swojego rozwoju.',
          ...
          warZamk: ['Osiągnięcie poziomu opisanego w idei stopnia i zrealizowanie wymagań próby.',
    ...
    Widget cardPHM = SimpleButton(
        ...
        onTap: () => showScrollBottomSheet(
          ...
          builder: (context) => BottomSheetStopien(
            ...
            warOtw: ['Pozytywnie oceniona praca instruktorska przez co najmniej 12 miesięcy od przyznania stopnia przewodnika.',
            ...
            zadania: ['Wykazał się umiejętnością pracy nad sobą, stawiania celów w życiu, podejmowania działań (do ich realizacji), ich oceny i wyciągania wniosków.',
