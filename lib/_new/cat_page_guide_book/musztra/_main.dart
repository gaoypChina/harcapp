...
class MusztraFragment extends StatelessWidget {
...
class Item extends StatelessWidget{
  ...
  const Item(this.title, this.description, {this.error});

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(top: Dimen.LIST_SEP_MARG/1.5, bottom: Dimen.LIST_SEP_MARG/1.5),
      child: Column(
          children: [
