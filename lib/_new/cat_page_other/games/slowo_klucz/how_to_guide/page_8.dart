...
import 'package:harcapp/_new/cat_page_other/games/slowo_klucz/common/preview_cards_grid_widget.dart';
...
class Page8State extends State<Page8> with PageTemplateInterface{
  ...
  void initState() {
    ...
    animStageManager = AnimStageManager(
        ...
        stages: [
          ...
          AnimStage(
              function: () => controller[6].toggleCard(),
              after: animDuration),

          AnimStage(
              function: (){
                convText = 'Łatwizna. Co dalej? Piece są chyba często okrądłe.';
                setState(() => animStage = 2);
              },
              after: animDuration + convDuration),
          AnimStage(
          ...
          AnimStage(
              function: (){
                convText = 'Klikamy? Ja bym klikał.';
                setState(() => animStage = 2);
              },
              after: animDuration + convDuration),
          AnimStage(
          ...
          AnimStage(
              function: () => controller[5].toggleCard(),
              after: animDuration),

          AnimStage(
              function: (){
                convText = 'No nie! Przegraliśmy!';
                setState(() => animStage = 2);
              },
              after: animDuration + convDuration),
          AnimStage(
          ...
          AnimStage(
              function: (){
                convColor = RED_COLOR;
                convAuth = 'Wódz czerwonych';
                convText = 'Jesteście imbecylami. Słowo daję.';
                setState(() => animStage = 1);
              },
              after: animDuration + convDuration),
          AnimStage(
        ...
        cleanUp: (){
          controller[6].toggleCard();
          controller[5].toggleCard();
  ...
  Widget build(BuildContext context) {
    ...
    return PageTemplate(
      ...
      text: 'Wariant 3:\nJeżeli drużyna wybierze czarną kartę, przegrywa grę. Wygrywa drużyna przeciwna.',
