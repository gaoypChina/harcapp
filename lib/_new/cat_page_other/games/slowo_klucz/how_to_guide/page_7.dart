...
class Page7 extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState() => Page7State();


}

class Page7State extends State<Page7> with PageTemplateInterface{
  ...
  void initState() {
    ...
    animStageManager = AnimStageManager(
        ...
        stages: [
          ...
          AnimStage(
              function: (){
                convText = 'Wtopiliśmy. Teraz tura zielonych.';
                setState(() => animStage = 2);
              },
              after: animDuration + convDuration),
          AnimStage(
  ...
  Widget build(BuildContext context) {
    ...
    return PageTemplate(
      ...
      text: 'Wariant 2:\nJeżeli drużyna wybierze kartę neutralną lub drużyny przeciwnej, kończy swoją turę.',
