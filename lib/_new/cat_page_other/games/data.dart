...
import 'package:harcapp/_new/cat_page_other/games/slowo_klucz/_main.dart';
import 'package:harcapp/_new/cat_page_other/games/slowo_klucz/how_to_guide/_how_to_guide.dart';
import 'package:harcapp_core/comm_classes/color_pack.dart';
import 'package:harcapp/_new/cat_page_other/games/pytaki/_main.dart';
import 'package:harcapp/_new/cat_page_other/games/pytaki/how_to.dart';
import 'package:harcapp/_new/cat_page_other/games/slowo_klucz/how_to.dart';
...
GameData gameDataPytajki = GameData(
  ...
  builder: (context) => GamePytakiPage(),
  builderHowToDescription: (context) => HowToPytajki(),
  coverImg: 'bg_pytajki',
  name: 'Pytajki',
