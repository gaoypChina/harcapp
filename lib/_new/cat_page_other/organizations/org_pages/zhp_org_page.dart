...
class ZHPOrgPage extends StatelessWidget{
    ...
    return BottomNavScaffold(
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverAppBar(
            title: Text('Związek Harcerstwa Polskiego'),
            centerTitle: true,
            floating: true,
          ),
                  ...
                  children: <Widget>[
                    Expanded(
                      child: SimpleButton(
                        ...
                        child: Icon(MdiIcons.facebook, color: AppColors.zhp_green),
                      ),
                    ),
                    Expanded(
                      child: SimpleButton(
                        ...
                        child: Icon(MdiIcons.twitter, color: AppColors.zhp_green),
                      ),
                    ),
                    Expanded(
                      child: SimpleButton(
                        ...
                        child: Icon(MdiIcons.instagram, color: AppColors.zhp_green),
                      ),
                    ),
                  ],
                ),
