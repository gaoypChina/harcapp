...
List<TropBaseData> zuchTrops = [
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy wstąpić do szkoły teatralnej.'),
        TropTaskBaseData(content: 'Poznaliśmy historię polskiego teatru lub kina i najwybitniejszych polskich aktorów.'),
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy spotkać się z muzami – opiekunkami sztuki i nauki.'),
        TropTaskBaseData(content: 'Spotkaliśmy się z muzami, które przedstawiły nam różne formy sztuki.'),
        TropTaskBaseData(content: 'Nasze prace wykonane podczas majsterki z muzami zebraliśmy we wspólnym albumie sztuki zuchowej.'),
        TropTaskBaseData(content: 'Efekty naszych działań muzycznych i aktorskich nagraliśmy i udostępniliśmy rodzicom oraz przyjaciołom gromady.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy happening podsumowujący spotkania z Muzami.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy wstąpić do akademii muzycznej.'),
        TropTaskBaseData(content: 'Spotkaliśmy się z muzykiem/piosenkarzem, który opowiedział nam o swojej pasji/zawodzie. Poznaliśmy instrumenty, z których korzysta w swojej pracy.'),
        TropTaskBaseData(content: 'Poznaliśmy gamę, nauczyliśmy się zapisywać i odczytywać nuty.'),
        TropTaskBaseData(content: 'Byliśmy na występie dowolnej formacji muzycznej.'),
        TropTaskBaseData(content: 'Poznaliśmy różne gatunki muzyczne (np. muzyka chóralna, elektroniczna, instrumentalna, rock, hip-hop, pop, jazz). Próbowaliśmy wykonywać utwory tych gatunków.'),
        TropTaskBaseData(content: 'Urządziliśmy wystawę poświęconą największym polskim kompozytorom.'),
        TropTaskBaseData(content: 'Wykonaliśmy własne instrumenty.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy prezentację minilisty przebojów, podczas której naśladowaliśmy znanych wykonawców.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy kończący akademię wieczór „W krainie muzyki”.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy założyć własne stowarzyszenie literackie.'),
        TropTaskBaseData(content: 'Poznaliśmy słynnych polskich poetów i pisarzy.'),
        TropTaskBaseData(content: 'Wykonaliśmy własne pióra pisarskie.'),
        TropTaskBaseData(content: 'Uczyliśmy się sztuki kaligrafii piórem.'),
        TropTaskBaseData(content: 'Poznaliśmy utwory literackie z różnych epok i język, jakim były pisane.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy zbiórkę książek, które przekazaliśmy potrzebującym.'),
        TropTaskBaseData(content: 'Uczyliśmy się tworzyć opowieści na podstawie dowolnie ułożonych obrazków, kończyliśmy opowiadania, układaliśmy wiersze i bajki.'),
        TropTaskBaseData(content: 'Układaliśmy melodie do ułożonych przez nas wierszyków.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wieczór recytatorski dla naszych najbliższych, podczas którego prezentowaliśmy własną twórczość.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'Dostaliśmy zlecenie na realizację filmu animowanego. W kręgu rady postanowiliśmy podjąć to wyzwanie.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, jak powstają filmy animowane.'),
        TropTaskBaseData(content: 'Wybraliśmy się na wirtualny spacer po Studiu Filmów Rysunkowych.'),
        TropTaskBaseData(content: 'Przeprowadziliśmy lub obejrzeliśmy wywiad z twórcą filmów animowanych.'),
        TropTaskBaseData(content: 'Założyliśmy zuchową wytwórnię filmów animowanych. Wymyśliliśmy jej nazwę i logo.'),
        TropTaskBaseData(content: 'Urządziliśmy maraton krótkometrażowych filmów animowanych lub festiwal piosenki filmowej. Każda szóstka zaprezentowała wybrany film lub piosenkę.'),
        TropTaskBaseData(content: 'Podkładaliśmy głos do naszych ulubionych filmów. Uczyliśmy się modulować go w sposób charakterystyczny dla niektórych bohaterów kreskówek.'),
        TropTaskBaseData(content: 'Wprawiliśmy w ruch własnoręcznie wykonane rysunki, lalki, figurki z gliny. Poznaliśmy różne techniki animacji.'),
        TropTaskBaseData(content: 'Zaprojektowaliśmy i zrealizowaliśmy film o ważnej dla nas sprawie. Wybraliśmy wspólnie temat.'),
        TropTaskBaseData(content: 'Zaprezentowaliśmy nasz film rodzicom i przyjaciołom. Wykonaliśmy promujący go plakat.'),
        TropTaskBaseData(content: 'Na podsumowanie urządziliśmy wielki konkurs wiedzy o filmach animowanych.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy zostać tancerzami.'),
        TropTaskBaseData(content: 'Poznaliśmy taniec ludowy. Dowiedzieliśmy się, z jakiego regionu pochodzi.'),
        TropTaskBaseData(content: 'Byliśmy na występie dowolnej formacji tanecznej.'),
        TropTaskBaseData(content: 'Poznaliśmy kilka tańców integracyjnych.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy integracyjne zajęcia taneczne dla środowisk Nieprzetartego Szlaku lub seniorów.'),
        TropTaskBaseData(content: 'Wykonaliśmy części stroju tancerzy i tancerek oraz wystrój sali tanecznej z materiałów z recyklingu.'),
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady przyjęliśmy zaproszenie od mistrza rękodzielnictwa. Postanowiliśmy wstąpić do cechu i uczyć się różnych technik rękodzielniczych.'),
        TropTaskBaseData(content: 'Byliśmy w muzeum prezentującym wybrane rękodzieło (np. wikliniarstwo, snycerstwo, garncarstwo, rzeźbiarstwo, krawiectwo, tkactwo, stolarstwo, zabawkarstwo, szopki bożonarodzeniowe).'),
        TropTaskBaseData(content: 'Spotkaliśmy się z twórcą wybranego rodzaju rękodzieła. Pokazał nam, jak wygląda jego praca.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, jak możemy wykorzystać rzeczy już niepotrzebne (odpady) i gdzie należy wyrzucać rzeczy niezdatne do użycia.'),
        TropTaskBaseData(content: 'Stworzyliśmy emblematy naszych szóstek z gliny lub origami. Powiesiliśmy je na naszej gazetce.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, czym jest aparat i jak zrobić dobre zdjęcie.'),
        TropTaskBaseData(content: 'Wykorzystaliśmy niepotrzebne tkaniny lub stare koszulki. Posługiwaliśmy się igłą i nitką.'),
        TropTaskBaseData(content: 'Zrobiliśmy zdjęcia szóstek i umieściliśmy je w kronice.'),
        TropTaskBaseData(content: 'Tworzyliśmy kartki pocztowe różnymi technikami (np. scrapbooking, decoupage, embossing, quilling).'),
        TropTaskBaseData(content: 'Decyzją rady cechu zostaliśmy mianowani mistrzami rękodzieła.'),
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy założyć Zuchową Akademię Plastyczną.'),
        TropTaskBaseData(content: 'Urządziliśmy własną pracownię plastyczną. Wykonywaliśmy prace plastyczne różnymi technikami.'),
        TropTaskBaseData(content: 'W pracowni odkrywaliśmy tajniki malarstwa.'),
        TropTaskBaseData(content: 'Zwiedziliśmy wystawę malarską w galerii lub w muzeum.'),
        TropTaskBaseData(content: 'Poznaliśmy znanych polskich malarzy i rzeźbiarzy.'),
        TropTaskBaseData(content: 'Odmalowaliśmy zaniedbany mur lub ścianę, wykonując zuchowy mural lub zorganizowaliśmy zuchową galerię.'),
        TropTaskBaseData(content: 'Szóstkami wykonaliśmy rzeźby z odpadów (np. z gazet).'),
        TropTaskBaseData(content: 'Urządziliśmy spotkanie integracyjne „kredą po asfalcie” dla dzieci z podwórka.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzje o wstąpieniu do szkoły magii.'),
        TropTaskBaseData(content: 'Wykonaliśmy stroje czarodziejów oraz magiczne różdżki.'),
        TropTaskBaseData(content: 'Uczyliśmy się czarodziejskich sztuczek i zaklęć, magicznego pisma (szyfrów), zastosowania ziół i alchemicznych symboli.'),
        TropTaskBaseData(content: 'Oglądaliśmy, a następnie sami zorganizowaliśmy pokaz sztuk magicznych.'),
        TropTaskBaseData(content: 'Byliśmy w czarnoksięskiej bibliotece. Szukaliśmy tam historii i legend o czarnoksiężnikach, czarodziejach i magii. W szóstkach przygotowaliśmy i przedstawiliśmy wybraną opowieść.'),
        TropTaskBaseData(content: 'Spotkaliśmy się z czarodziejem – Panem Twardowskim, Malutką Czarownicą lub Harrym Potterem.'),
        TropTaskBaseData(content: 'Tropiliśmy tajemnicę i dzięki zdobytej wiedzy rozwiązywaliśmy zagadki. Wykazaliśmy się cechami potrzebnymi dobrym czarodziejom.'),
        TropTaskBaseData(content: 'Na podsumowanie urządziliśmy bal na miotłach lub sabat czarownic.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że chcemy poznać krainę elfów i żyć w zgodzie z Matką Naturą.'),
        TropTaskBaseData(content: 'Byliśmy na wycieczce w lesie, gdzie spotkaliśmy elfa – leśnego opiekuna, który pokazał nam piękno i dary przyrody, a także choroby Matki Natury.'),
        TropTaskBaseData(content: 'Odwiedziliśmy Rivendell, miasto elfów. Przeszliśmy tam szkolenie leśnych strażników.'),
        TropTaskBaseData(content: 'Pracując w szóstkach, zbudowaliśmy własną wioskę elfów. Nie zniszczyliśmy przy tym przyrody.'),
        TropTaskBaseData(content: 'Wykonaliśmy płaszcze elfów i amulety o tajemniczej mocy.'),
        TropTaskBaseData(content: 'Ćwiczyliśmy sprawność fizyczną i zmysły. Zrobiliśmy łuki, uczyliśmy się z nich strzelać.'),
        TropTaskBaseData(content: 'Przeprowadzaliśmy narady w tajemnym kręgu elfów.'),
        TropTaskBaseData(content: 'Staraliśmy się być niewidoczni w lesie: przekradaliśmy się bezgłośnie, wykonaliśmy kamuflaż i zacieraliśmy po sobie ślady.'),
        TropTaskBaseData(content: 'Nauczyliśmy się poruszać po lesie tak, by się nie zgubić. Poznaliśmy kilka prostych sposobów wyznaczania północy.'),
        TropTaskBaseData(content: 'Wódz elfów przekazał nam tajniki ziołolecznictwa i sekrety dbania o rośliny.'),
        TropTaskBaseData(content: 'Poznaliśmy leśną zwierzynę i jej zwyczaje. Wraz z Legolasem tropiliśmy ją w leśnych ostępach.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, że las składa się z warstw. Poznaliśmy zwierzęta i rośliny występujące w poszczególnych warstwach. W każdej z warstw lasu szukaliśmy pożywienia.'),
        TropTaskBaseData(content: 'Wykonaliśmy kilka pożytecznych prac na rzecz lasu.'),
        TropTaskBaseData(content: 'Na podsumowanie leśnej przygody urządziliśmy leśną ucztę z zebranych przez nas darów natury.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzje o wstąpieniu do Klubu Fantastów.'),
        TropTaskBaseData(content: 'Oglądaliśmy film fantastyczny.'),
        TropTaskBaseData(content: 'Zbudowaliśmy wehikuł, którym podróżowaliśmy w czasie i przestrzeni.'),
        TropTaskBaseData(content: 'Bawiliśmy się w biuro ekspertów do spraw przyszłych losów świata.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy spotkanie z istotami z innych planet. Podpisaliśmy z nimi pakt przyjaźni.'),
        TropTaskBaseData(content: 'Pracując w szóstkach, wykonaliśmy makietę miasteczka przyszłości.'),
        TropTaskBaseData(content: 'Urządziliśmy Teatr Niesamowitych Przypadków. Każda szóstka przedstawiała swoją historię.'),
        TropTaskBaseData(content: 'Urządziliśmy pokaz mody „nie z tej ziemi”.'),
        TropTaskBaseData(content: 'Urządziliśmy w szkole przegląd prac plastycznych na temat fantastycznych wizji świata w 3000 roku.'),
        TropTaskBaseData(content: 'Na zakończenie podsumowaliśmy nasze fantastyczne wyprawy i zorganizowaliśmy wybór Fantasty Roku'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że chcemy bliżej poznać mieszkańców Gumisiowej Doliny.'),
        TropTaskBaseData(content: 'Oglądaliśmy bajkę pt. „Gumisie”.'),
        TropTaskBaseData(content: 'Pracując w szóstkach, urządziliśmy siedzibę Gumisiów.'),
        TropTaskBaseData(content: 'Byliśmy z wizytą na zamku Dunwyn.'),
        TropTaskBaseData(content: 'Przygotowaliśmy sok z gumijagód. Zorganizowaliśmy zawody szóstek na najlepszych skoczków.'),
        TropTaskBaseData(content: 'Wykorzystując Magiczną Księgę Gumisiów, braliśmy udział w lekcji magii i czarów.'),
        TropTaskBaseData(content: 'Wyruszyliśmy na ratunek potrzebującym.'),
        TropTaskBaseData(content: 'Gospodarowaliśmy w kuchni Buni.'),
        TropTaskBaseData(content: 'Odkrywaliśmy swoje artystyczne talenty pod okiem Gusto.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę w celu poznania najbliższego otoczenia.'),
        TropTaskBaseData(content: 'Majsterkowaliśmy razem z Grafim.'),
        TropTaskBaseData(content: 'Na podsumowanie urządziliśmy wielką ucztę.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'Dostaliśmy od krasnoludków list, w którym zaprosiły nas do swojego świata. W kręgu rady postanowiliśmy pomóc krasnoludkom w ich pracach.'),
        TropTaskBaseData(content: 'Poznaliśmy bajkę „O krasnoludkach i sierotce Marysi”, „Królewna Śnieżka i siedmiu krasnoludków” lub inną bajkę o krasnoludkach.'),
        TropTaskBaseData(content: 'Urządziliśmy krasnoludkową grotę.'),
        TropTaskBaseData(content: 'W wielkiej tajemnicy zrobiliśmy drobne, dobre uczynki.'),
        TropTaskBaseData(content: 'Braliśmy udział w krasnoludkowym święcie (powitaniu wiosny, poszukiwaniu kwiatu paproci).'),
        TropTaskBaseData(content: 'Zorganizowaliśmy bal krasnoludków, Święto Kwiatów lub krasnoludkową ucztę. Każda szóstka była odpowiedzialna za część wydarzenia.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy zabawę lub przedstawienie dla młodszych dzieci. Pokazaliśmy im, że warto być życzliwym i opiekuńczym jak krasnoludki.'),
        TropTaskBaseData(content: 'Podpatrywaliśmy kiełkowanie lub zakwitanie rośliny, powrót ptaków.'),
        TropTaskBaseData(content: 'Rozpoznawaliśmy głosy zwierząt. Próbowaliśmy zrozumieć mowę wybranego zwierzęcia.'),
        TropTaskBaseData(content: 'Podjęliśmy wspólnie pożyteczną pracę w naszej okolicy.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę do Calineczki, Tomcia Palucha, Smerfów lub innych małych przyjaciół. Wspólnie podjęliśmy decyzję o chronieniu krasnoludkowego/bajkowego świata.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że wyruszymy na wyprawę do Stumilowego Lasu i poznamy jego mieszkańców.'),
        TropTaskBaseData(content: 'Urządziliśmy kryjówkę w Stumilowym Lesie.'),
        TropTaskBaseData(content: 'Przeżywaliśmy lub inscenizowaliśmy szóstkami przygody Kubusia Puchatka i jego przyjaciół.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy „przyprawę do bieguna północnego”.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy podwórkowy turniej zabaw w „misie patysie”.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, skąd się bierze „małe co nieco”. Przygotowaliśmy przysmaki dla Kubusia Puchatka i jego przyjaciół.'),
        TropTaskBaseData(content: 'Wymyślaliśmy zagadki i mruczanki Kubusia.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wystawę naszych ulubionych pluszowych zabawek.'),
        TropTaskBaseData(content: 'Zrobiliśmy makietę Stumilowego Lasu.'),
        TropTaskBaseData(content: 'Pod okiem Królika założyliśmy i pielęgnowaliśmy ogródek.'),
        TropTaskBaseData(content: 'Na zakończenie urządziliśmy piknik w Stumilowym Lesie lub turniej o średni rozumek.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że wyruszymy na wyprawę z Małym Księciem.'),
        TropTaskBaseData(content: 'Razem z Małym Księciem odbyliśmy podróż po innych planetach. Odwiedziliśmy planety: Króla, Pyszałka, Opoja, Biznesmena, Latarnika, Geografa oraz Ziemię.'),
        TropTaskBaseData(content: 'Wykonaliśmy rysunki pobudzające wyobraźnię (np. węża, który połknął słonia, owieczkę w skrzyni).'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, czym różnią się od siebie gwiazdy i planety. Wraz z Małym Księciem oglądaliśmy zachód słońca.'),
        TropTaskBaseData(content: 'Poszukiwaliśmy przyjaciół w szkole, w drużynie, na podwórku. Wraz z lisem szukaliśmy kogoś, kogo moglibyśmy „oswoić”.'),
        TropTaskBaseData(content: 'Zaprzyjaźniliśmy się z inną gromadą, odwiedziliśmy jej planetę.'),
        TropTaskBaseData(content: 'Szóstkami hodowaliśmy własną roślinkę. Opiekowaliśmy się nią. Dbaliśmy, by niczego jej nie brakowało.'),
        TropTaskBaseData(content: 'Nauczyliśmy się piosenki pt. „Mały Książę”.'),
        TropTaskBaseData(content: 'Na podsumowanie zorganizowaliśmy Święto Przyjaźni w gromadzie, szkole lub na podwórku.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzję o podróży do odległej Krainy Emocji.'),
        TropTaskBaseData(content: 'Obejrzeliśmy film pt. „W głowie się nie mieści”.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, co to są emocje i kiedy je odczuwamy. Zobaczyliśmy, jak wygląda mózg człowieka i dowiedzieliśmy się, która jego część odpowiada za emocje.'),
        TropTaskBaseData(content: 'Poznaliśmy różne emocje (radość, smutek, strach, gniew, odraza) i sposoby ich wyrażania. Zorganizowaliśmy „Zuchowy teatr uczuć”.'),
        TropTaskBaseData(content: 'Odbyliśmy podróż do Krainy Emocji. Odwiedziliśmy wyspy więzi rodzinnych, przyjaźni, zabawy, szczerości i zainteresowań.'),
        TropTaskBaseData(content: 'Cieszymy się ze swoich sukcesów. Stworzyliśmy tablicę pozytywnych myśli.'),
        TropTaskBaseData(content: 'Poznaliśmy sposoby radzenia sobie ze złością. Urządziliśmy w naszej zuchówce kącik, w którym możemy się uspokoić.'),
        TropTaskBaseData(content: 'Wcieliliśmy się w postać małej żabki (z książki E. Snel). Nauczyliśmy się skupiać na danej chwili i relaksować się.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy festiwal muzyczny. Każda szóstka wykonała piosenkę wyrażającą wybraną emocję.'),
        TropTaskBaseData(content: 'Bawiliśmy się w bajkopisarzy. Stworzyliśmy opowiadania lub komiksy, w których bohaterowie przeżywali różne emocje.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, że nie ma dobrych i złych emocji. Nauczyliśmy się kontrolować swoje emocje w trudnych sytuacjach. Prowadziliśmy „Dzienniczek emocji”.'),
        TropTaskBaseData(content: 'Rozmawialiśmy w gromadzie o tym, gdzie możemy uzyskać pomoc, gdy coś się dzieje. Poznaliśmy specjalne numery telefonów pomocy.'),
        TropTaskBaseData(content: 'Na podsumowanie zorganizowaliśmy bal emocji.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy o przyłączeniu się do Wilczej Gromady.'),
        TropTaskBaseData(content: 'Urządziliśmy kryjówkę w lesie (szałas, jaskinię). Sporządziliśmy sobie leśne stroje.'),
        TropTaskBaseData(content: 'Nauczyliśmy się bezpiecznie posługiwać się ogniem. Rozpaliliśmy ognisko, ugotowaliśmy na nim potrawę. W szóstkach wykonaliśmy posiłek z samodzielnie zebranych leśnych owoców.'),
        TropTaskBaseData(content: 'Byliśmy na kilku wyprawach, podczas których poznaliśmy okolice naszej leśnej kryjówki. Potrafimy wskazać mrowiska, ciekawe drzewa i tajemnicze miejsca.'),
        TropTaskBaseData(content: 'Ułożyliśmy własne prawa i rzetelnie ich przestrzegaliśmy.'),
        TropTaskBaseData(content: 'Skradaliśmy się i obserwowaliśmy zwierzęta. Rozpoznawaliśmy tropy, np. zająca, sarny, psa.'),
        TropTaskBaseData(content: 'Szóstkami inscenizowaliśmy przygody bohaterów „Księgi dżungli”.'),
        TropTaskBaseData(content: 'Braliśmy udział w uwolnieniu Mowgliego z rąk małp Bondar Logi.'),
        TropTaskBaseData(content: 'Odnaleźliśmy skarb Białej Kobry.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy, że odwiedzimy Dolinę Muminków.'),
        TropTaskBaseData(content: 'Oglądaliśmy bajkę pt. „Muminki” lub czytaliśmy książki o Muminkach.'),
        TropTaskBaseData(content: 'Zbudowaliśmy domek Muminków.'),
        TropTaskBaseData(content: 'Przeżywaliśmy lub szóstkami inscenizowaliśmy przygody Muminków lub ich przyjaciół.'),
        TropTaskBaseData(content: 'Wędrowaliśmy szlakiem opowiadań Włóczykija. Prawidłowo spakowaliśmy się na wycieczkę.'),
        TropTaskBaseData(content: 'Przygotowaliśmy przysmaki z kuchni mamy Maminka.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy morską wyprawę szlakiem przygód taty Muminka.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę na Wyspę Hatifnatów i poznaliśmy ich tajemnicę.'),
        TropTaskBaseData(content: 'Odkryliśmy historię komety nad Doliną Muminków.'),
        TropTaskBaseData(content: 'Na podsumowanie zorganizowaliśmy podwórkowy turniej przyjaciół Muminka.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że wyruszymy na wyprawę do Narnii.'),
        TropTaskBaseData(content: 'Zapoznaliśmy się z treścią pierwszej części „Opowieści z Narnii” pt. „Lew, czarownica i stara szafa”. Wspólnie czytaliśmy fragmenty książki, słuchaliśmy ich lub oglądaliśmy film.'),
        TropTaskBaseData(content: 'Znaleźliśmy magiczną szafę, która przeniosła nas do baśniowej krainy.'),
        TropTaskBaseData(content: 'Odwiedziliśmy mieszkanie pana Tumnusa oraz tamę państwa Bobrów. Wspólnie z nimi przygotowaliśmy podwieczorek i śpiewaliśmy narnijskie kołysanki.'),
        TropTaskBaseData(content: 'Przygotowaliśmy zbroje z symbolem Lwa, urządziliśmy turniej rycerski, uczyliśmy się strzelać z łuku, używać szpady i jeździć konno.'),
        TropTaskBaseData(content: 'Wybraliśmy się na wędrówkę szlakiem Wielkiej Rzeki, aby odnaleźć ślady mówiących zwierząt i tańczących drzew. Zbadaliśmy przyrodę. Zbudowaliśmy zamek Ker Paravel.'),
        TropTaskBaseData(content: 'Przeprowadziliśmy konkurs plastyczny pt. „Jak wygląda kraina Aslana?”.'),
        TropTaskBaseData(content: 'Wraz z królem Piotrem przeszliśmy próbę prawdziwej odwagi.'),
        TropTaskBaseData(content: 'Wraz z królowymi Zuzanną i Łucją uczyliśmy się zasad savoir-vivre.'),
        TropTaskBaseData(content: 'Dzięki naszej wytrwałości i chęci czynienia dobra uratowaliśmy Narnię przed Białą Czarownicą.'),
        TropTaskBaseData(content: 'Spotkaliśmy Wielkiego Lwa, który jest strażnikiem wszystkich Narnijczyków.'),
        TropTaskBaseData(content: 'Na zakończenie razem z mieszkańcami Narnii urządziliśmy bal na zamku.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzję o wstąpieniu do Akademii Pana Kleksa.'),
        TropTaskBaseData(content: 'Oglądaliśmy film „Akademia Pana Kleksa”, „Podróże Pana Kleksa”, „Pan Kleks w Kosmosie” lub „Tryumf Pana Kleksa”.'),
        TropTaskBaseData(content: 'Uczestniczyliśmy w zajęciach w Akademii Pana Kleksa. Byliśmy na lekcji bajkologii, kleksografii, bańkologii, wierszologii, geografii.'),
        TropTaskBaseData(content: 'Podróżowaliśmy razem z Panem Kleksem.'),
        TropTaskBaseData(content: 'Przyrządzaliśmy przysmaki w kuchni Pana Kleksa.'),
        TropTaskBaseData(content: 'Urządziliśmy w szóstkach zawody balonów.'),
        TropTaskBaseData(content: 'Szukaliśmy zaginionego guzika szpaka Mateusza.'),
        TropTaskBaseData(content: 'Zbieraliśmy nasze sny z sennych lusterek.'),
        TropTaskBaseData(content: 'Inscenizowaliśmy bajki i przygody Pana Kleksa.'),
        TropTaskBaseData(content: 'Układaliśmy własne bajki.'),
        TropTaskBaseData(content: 'Leczyliśmy chore sprzęty.'),
        TropTaskBaseData(content: 'Na zakończenie otrzymaliśmy dyplom ukończenia Akademii Pana Kleksa.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że wraz z Panem Samochodzikiem będziemy tropić zagadki historyczne.'),
        TropTaskBaseData(content: 'Czytając książki lub oglądając film, poznaliśmy przygody Pana Samochodzika.'),
        TropTaskBaseData(content: 'Jeździliśmy wehikułem Pana Samochodzika.'),
        TropTaskBaseData(content: 'Szukaliśmy skarbu templariuszy, odwiedziliśmy Wyspę Złoczyńców i Niesamowity Dwór.'),
        TropTaskBaseData(content: 'Założyliśmy „Księgę strachów”.'),
        TropTaskBaseData(content: 'Odnaleźliśmy w swojej okolicy zapomniane miejsca historyczne.'),
        TropTaskBaseData(content: 'Odwiedziliśmy muzeum, skansen, zamek lub inny zabytek.'),
        TropTaskBaseData(content: 'Założyliśmy Ligę do Walki z Hałasem.'),
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy wyruszyć z Piotrusiem Panem do Nibylandii.'),
        TropTaskBaseData(content: 'Zaprzyjaźniliśmy się z Zagubionymi Chłopcami. Otrzymaliśmy imiona nadane przez Piotrusia Pana.'),
        TropTaskBaseData(content: 'Zbudowaliśmy dom-drzewo, w którym każda szóstka miała swoje miejsce.'),
        TropTaskBaseData(content: 'Założyliśmy Bank Szczęśliwych Myśli. Na każdej zbiórce obdarowywaliśmy się nawzajem tymi myślami.'),
        TropTaskBaseData(content: 'Pomagaliśmy Piotrusiowi złapać jego cień. Wykonaliśmy galerię własnych cieni.'),
        TropTaskBaseData(content: 'Szóstkami inscenizowaliśmy wybrane przygody Piotrusia Pana.'),
        TropTaskBaseData(content: 'Wyruszyliśmy z Piotrusiem do Laguny Syren, by wsłuchiwać się w ich przepiękny śpiew. Poznawaliśmy uroki przyrody w Nibylandii.'),
        TropTaskBaseData(content: 'Tropiliśmy po odgłosach krokodyla, który połknął budzik.'),
        TropTaskBaseData(content: 'Wraz z Dzwoneczkiem uczyliśmy się latać w naszych marzeniach.'),
        TropTaskBaseData(content: 'Odbiliśmy Tygrysią Lilię z rąk Kapitana Haka.'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że chcemy zaprzyjaźnić się z Plastusiem.'),
        TropTaskBaseData(content: 'Zbudowaliśmy mieszkanie Plastusia.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy konkurs na najładniejszy pamiętnik.'),
        TropTaskBaseData(content: 'Braliśmy udział w plastusiowych przygodach.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wystawę plastelinowych prac.'),
        TropTaskBaseData(content: 'Ułożyliśmy nowe przygody Plastusia i jego przyjaciół.'),
        TropTaskBaseData(content: 'Zaprosiliśmy na zbiórkę gościa, który opowiedział nam, jak dawniej wyglądała nauka w szkole.'),
        TropTaskBaseData(content: 'Nauczyliśmy się kaligrafować swoje imię i nazwisko. Zapisywaliśmy nasze przygody w pamiętniku.'),
        TropTaskBaseData(content: 'Oprowadziliśmy Plastusia po naszej szkole.'),
        TropTaskBaseData(content: 'Na podsumowanie inscenizowaliśmy szóstkami wybrane przygody Plastusia.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy poznać tajemniczy świat bajek.'),
        TropTaskBaseData(content: 'Oglądaliśmy lub czytaliśmy swoje ulubione bajki.'),
        TropTaskBaseData(content: 'Poznawaliśmy nowe bajki.'),
        TropTaskBaseData(content: 'Bawiliśmy się w przygody bajkowych bohaterów.'),
        TropTaskBaseData(content: 'Szóstkami inscenizowaliśmy przygody bajkowych bohaterów.'),
        TropTaskBaseData(content: 'Układaliśmy własne bajki lub wymyślaliśmy dalsze losy znanych bohaterów. Opowiadając nasze historie, imitowaliśmy różne dźwięki (np. szum wiatru, odgłosy zwierząt).'),
        TropTaskBaseData(content: 'Założyliśmy „Księgę bajek”.'),
        TropTaskBaseData(content: 'Na podsumowanie zorganizowaliśmy wieczór bajek lub braliśmy udział w wielkim bajkowym karnawale.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że wyruszymy na Madagaskar.'),
        TropTaskBaseData(content: 'Obejrzeliśmy fragment filmu pt. „Madagaskar”.'),
        TropTaskBaseData(content: 'Szóstkami inscenizowaliśmy lub przeżywaliśmy przygody filmowych bohaterów.'),
        TropTaskBaseData(content: 'Urządziliśmy wycieczkę do zoo, gdzie oglądaliśmy takie zwierzęta, jak występujące w filmie. Dowiedzieliśmy się, gdzie żyją one w warunkach naturalnych.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wielkie przygotowania do podróży.'),
        TropTaskBaseData(content: 'Odbyliśmy podróż na Madagaskar. Dowiedzieliśmy się, gdzie leży ta wyspa oraz jakie zwierzęta i rośliny na niej występują. Poznaliśmy zwyczaje ludzi zamieszkujących Madagaskar.'),
        TropTaskBaseData(content: 'Wykonaliśmy maski zwierząt (lwa, zebry, żyrafy, hipopotama) i skompletowaliśmy resztę przebrania, w którym wystąpiliśmy na balu.'),
        TropTaskBaseData(content: 'Urządziliśmy bal u króla Juliana pt. „Wyginam śmiało ciało”. Wzięliśmy udział w konkursie tańca, prezentując własną choreografię do piosenki przewodniej.'),
        TropTaskBaseData(content: 'Leczyliśmy żyrafę Melmana z wymyślonych dolegliwości. Dowiedzieliśmy się, czym jest hipochondria.'),
        TropTaskBaseData(content: 'Przeszliśmy szkolenie dla tajnych agentów, które zorganizowały pingwiny z Madagaskaru. Sprawdziliśmy nasze umiejętności i zdobyliśmy tytuł Super Agenta.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, jakie zagrożenia czyhają na zwierzęta i przygotowaliśmy plakaty w obronie ich praw.'),
        TropTaskBaseData(content: 'Na zakończenie podpisaliśmy pakt przyjaźni, w którym określiliśmy, co jest ważne w relacjach między przyjaciółmi. Na wzór bohaterów „Madagaskaru” staramy się być solidarni i pomagać innym dzieciom w gromadzie.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że przyłączymy się do leśnych ludzi z Sherwood.'),
        TropTaskBaseData(content: 'Zbudowaliśmy kryjówkę leśnych ludzi.'),
        TropTaskBaseData(content: 'Złożyliśmy przysięgę Hernowi – panu drzew.'),
        TropTaskBaseData(content: 'Ćwiczyliśmy swoją sprawność fizyczną. Urządziliśmy na dworze szeryfa zawody łucznicze.'),
        TropTaskBaseData(content: 'W szóstkach układaliśmy ballady o czynach Robin Hooda i jego przyjaciół.'),
        TropTaskBaseData(content: 'Poznawaliśmy tajemnice naszego leśnego domu. Nauczyliśmy się bezszelestnie poruszać się po lesie.'),
        TropTaskBaseData(content: 'Przyrządzaliśmy leśne potrawy.'),
        TropTaskBaseData(content: 'Pomagaliśmy potrzebującym.'),
        TropTaskBaseData(content: 'Uwolniliśmy Marion z rąk niegodziwego szeryfa.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że wyruszymy na bezludną wyspę.'),
        TropTaskBaseData(content: 'Urządziliśmy naszą wyspę, zbudowaliśmy i zagospodarowaliśmy szałas i zagrodę. Lepiliśmy z gliny i wyplataliśmy koszyki. Zbudowaliśmy najprostszą kuchnię, zegar słoneczny i kalendarz. Prowadziliśmy dziennik.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę w celu poznania wyspy i sporządzenia jej mapy.'),
        TropTaskBaseData(content: 'Braliśmy udział w polowaniu (wyprawie po żywność). Badaliśmy jakość wody.'),
        TropTaskBaseData(content: 'Zbieraliśmy zioła i owoce, hodowaliśmy rośliny. W szóstkach przygotowaliśmy z nich posiłki.'),
        TropTaskBaseData(content: 'Rozpaliliśmy ogień różnymi sposobami.'),
        TropTaskBaseData(content: 'Zbudowaliśmy tratwę.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę na zatopiony statek.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę do sąsiedniego plemienia.'),
        TropTaskBaseData(content: 'Wyruszyliśmy na pomoc Piętaszkowi.'),
        TropTaskBaseData(content: 'Gościliśmy na naszej wyspie załogę statku, który przybył na ratunek. Pożegnaliśmy wyspę i uroczyście powitaliśmy ziemię ojczystą.'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzję o wstąpieniu do Zakonu Jedi.'),
        TropTaskBaseData(content: 'Oglądaliśmy bajkę z serii „Gwiezdne Wojny”.'),
        TropTaskBaseData(content: 'Opracowaliśmy kodeks Jedi i przestrzegaliśmy go na co dzień.'),
        TropTaskBaseData(content: 'Uczestniczyliśmy w szkoleniu pod okiem Mistrza Yody.'),
        TropTaskBaseData(content: 'Dbaliśmy o sprawność fizyczną, pracowaliśmy nad poprawą koncentracji.'),
        TropTaskBaseData(content: 'Zbudowaliśmy Sokoła Milenium. Podróżowaliśmy po galaktyce w misjach dyplomatycznych.'),
        TropTaskBaseData(content: 'Braliśmy udział w posiedzeniu Senatu, podczas którego decydowaliśmy o ważnych dla galaktyki sprawach.'),
        TropTaskBaseData(content: 'Przeżywaliśmy przygody wraz z bohaterami „Gwiezdnych Wojen”.'),
        TropTaskBaseData(content: 'Prezentowaliśmy przygotowane w szóstkach historie oraz legendy Zakonu Jedi.'),
        TropTaskBaseData(content: 'Wraz z Ewokami przygotowaliśmy ucztę z okazji zwycięstwa nad Imperatorem.'),
        TropTaskBaseData(content: 'Po przejściu szkolenia i odpowiednich prób zostaliśmy pasowani na Rycerzy Jedi.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy się zamieszkać w wiosce Smerfów.'),
        TropTaskBaseData(content: 'Oglądaliśmy bajkę pt. „Smerfy”.'),
        TropTaskBaseData(content: 'Zbudowaliśmy wioskę Smerfów lub urządziliśmy smerfowe chatki.'),
        TropTaskBaseData(content: 'Urządziliśmy wyprawę do lasu w poszukiwaniu smerfojagód.'),
        TropTaskBaseData(content: 'Braliśmy udział w wyprawie do siedziby Matki Natury oraz roztargnionego Ojca Czasu.'),
        TropTaskBaseData(content: 'Bawiliśmy się w niewidzialne Smerfy i pomagaliśmy Matce Naturze w sprzątaniu świata.'),
        TropTaskBaseData(content: 'Szóstkami inscenizowaliśmy przygody Smerfów.'),
        TropTaskBaseData(content: 'Podchodziliśmy zamek Gargamela. Podpisaliśmy z nim układ przyjaźni.'),
        TropTaskBaseData(content: 'Byliśmy z wizytą u Pasibrzucha. Pomagaliśmy mu znaleźć przyjaciół.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę do końca tęczy.'),
        TropTaskBaseData(content: 'Na podsumowanie zorganizowaliśmy bal w wiosce Smerfów, przygotowaliśmy ucztę, urządziliśmy przyjęcie urodzinowe i tańczyliśmy taniec 100 smerfów.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzję o wyprawie śladami Stasia i Nel.'),
        TropTaskBaseData(content: 'Odwiedziliśmy najbliższą palmiarnię, ogród botaniczny lub zoologiczny.'),
        TropTaskBaseData(content: 'Obejrzeliśmy film „W pustyni i w puszczy”. Oglądaliśmy albumy o Afryce.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wielkie przygotowania do podróży.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę do Afryki.'),
        TropTaskBaseData(content: 'Wędrowaliśmy przez pustynię, puszczę, dżunglę i sawannę lub w górę Nilu.'),
        TropTaskBaseData(content: 'Wyszukaliśmy i urządziliśmy kryjówkę „Kraków”.'),
        TropTaskBaseData(content: 'Inscenizowaliśmy szóstkami lub przeżywaliśmy sceny z książki „W pustyni i w puszczy” (porwanie Stasia i Nel, uwolnienie słonia lub inne).'),
        TropTaskBaseData(content: 'Byliśmy w afrykańskiej wiosce.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy pokojowe spotkanie plemion.'),
        TropTaskBaseData(content: 'Wysyłaliśmy wiadomości za pomocą latawca.'),
        TropTaskBaseData(content: 'Na podsumowanie zorganizowaliśmy turniej wiedzy o Afryce i jej mieszkańcach.'),
      ],
  ...
  TropBaseData(
      ...
      tasks: [
        ...
        TropTaskBaseData(content: 'Zbadaliśmy, z czego słynie kontynent afrykański.'),
        TropTaskBaseData(content: 'Zbudowaliśmy afrykańską chatę i całą wspólnotą plemienną ją udekorowaliśmy.'),
        TropTaskBaseData(content: 'Przyjęliśmy afrykańskie imiona i poznaliśmy afrykańskie zwyczaje. Wykonaliśmy maski, amulety lub elementy stroju.'),
        TropTaskBaseData(content: 'Poznaliśmy faunę i florę Afryki.'),
        TropTaskBaseData(content: 'Byliśmy w zoo, gdzie obserwowaliśmy zwierzęta żyjące w Afryce.'),
        TropTaskBaseData(content: 'Poznaliśmy baśnie i legendy afrykańskie. Szóstkami inscenizowaliśmy wybraną opowieść.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, jak żyją i w co się bawią nasi rówieśnicy w różnych regionach Afryki.'),
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzję o wyprawie do starożytnych Aten.'),
        TropTaskBaseData(content: 'Założyliśmy Akademię Ateńską, w której spotykaliśmy się z filozofami, dyskutowaliśmy i poznaliśmy kilka greckich liter.'),
        TropTaskBaseData(content: 'Studiowaliśmy sztukę teatru. Z materiałów nadających się do recyklingu wykonaliśmy potrzebne stroje, maski, koturny, podzieliliśmy się na aktorów i chór.'),
        TropTaskBaseData(content: 'Najciekawsze dla nas mity greckie wystawialiśmy na scenie.'),
        TropTaskBaseData(content: 'Uczestniczyliśmy w Dionizjach.'),
        TropTaskBaseData(content: 'Studiowaliśmy sztuki plastyczne. Lepiliśmy greckie naczynia z gliny.'),
        TropTaskBaseData(content: 'Pracując szóstkami, zbudowaliśmy makiety budynków Akropolu.'),
        TropTaskBaseData(content: 'Odtworzyliśmy przebieg bitwy pod Maratonem (490 r. p.n.e.), inscenizowaliśmy historię o dzielnym wodzu Militiadesie oraz o biegu gońca z Maratonu do Aten.'),
        TropTaskBaseData(content: 'Jako obywatele Aten uczestniczyliśmy w zgromadzeniach ludowych na Agorze. Nauczyliśmy się podstaw dyskusji i demokracji. Rozmawialiśmy o najważniejszych problemach naszej okolicy.'),
        TropTaskBaseData(content: 'Wyruszyliśmy na wyprawę na Olimp. Spotkaliśmy się z Zeusem, któremu opowiedzieliśmy, czego nauczyliśmy się w Akademii.'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy poznać życie zakonne benedyktynów.'),
        TropTaskBaseData(content: 'Byliśmy w klasztorze lub opactwie.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, czym zajmują się zakonnicy oraz siostry zakonne. Poznaliśmy opowieści o życiu benedyktynek i benedyktynów.'),
        TropTaskBaseData(content: 'Poznaliśmy legendy o życiu świętych. W szóstkach inscenizowaliśmy wybraną przez siebie legendę.'),
        TropTaskBaseData(content: 'Śpiewaliśmy modlitwę zuchową. Śpiewaliśmy chórem pieśni religijne.'),
        TropTaskBaseData(content: 'Zapisywaliśmy najważniejsze wiadomości w kronice gromady. Malowaliśmy ozdobne inicjały.'),
        TropTaskBaseData(content: 'Poznaliśmy najpopularniejsze zioła. Dowiedzieliśmy się, na jakie dolegliwości można je stosować.'),
        TropTaskBaseData(content: 'Codziennie spełniamy dobre uczynki.'),
        TropTaskBaseData(content: 'Zauważyliśmy w okolicy osoby potrzebujące. Zorganizowaliśmy zbiórkę niezbędnych im rzeczy.'),
        TropTaskBaseData(content: 'W kręgu rady podsumowaliśmy życie benedyktynów. Przekonaliśmy się, że pracą i poświęceniem możemy zmieniać świat.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzję o wstąpieniu do szkoły egipskiej.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, gdzie leży Egipt oraz jakie ma warunki naturalne i klimat.'),
        TropTaskBaseData(content: 'Zrobiliśmy makietę egipskiego domu, zbudowaliśmy świątynię i piramidy.'),
        TropTaskBaseData(content: 'Szóstkami inscenizowaliśmy egipskie mity. Znamy kilku egipskich bogów.'),
        TropTaskBaseData(content: 'Wędrowaliśmy wzdłuż Nilu. Dowiedzieliśmy się, jak ważna dla człowieka jest woda i jak można ją chronić. Budowaliśmy kanały irygacyjne.'),
        TropTaskBaseData(content: 'Nauczyliśmy się pisać hieroglifami na glinianych tabliczkach.'),
        TropTaskBaseData(content: 'Malowaliśmy zgodnie z zasadami sztuki egipskiej.'),
        TropTaskBaseData(content: 'Wyruszyliśmy na wyprawę w głąb piramidy Cheopsa. Poznaliśmy sposób, w jaki ją zbudowano. Dowiedzieliśmy się, kim byli faraonowie i dlaczego chowano ich'),
        TropTaskBaseData(content: 'w piramidach.'),
        TropTaskBaseData(content: 'Podsumowaliśmy naszą wiedzę i otrzymaliśmy dyplom ukończenia szkoły.'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy wyjechać na Grenlandię i zostać Eskimosami.'),
        TropTaskBaseData(content: 'Zbudowaliśmy igloo i spędziliśmy dzień w eskimoskiej wiosce.'),
        TropTaskBaseData(content: 'Poznaliśmy kilka eskimoskich zwyczajów i opowieści.'),
        TropTaskBaseData(content: 'Braliśmy udział w wyprawie po żywność ukrytą w lodowych kryjówkach.'),
        TropTaskBaseData(content: 'Urządziliśmy konkurs szóstek na najładniejszą rzeźbę śniegową.'),
        TropTaskBaseData(content: 'Braliśmy udział w badaniach lądolodu na Grenlandii. Dowiedzieliśmy się, co to jest globalne ocieplenie.'),
        TropTaskBaseData(content: 'Obchodziliśmy święto powracającego dnia. Dowiedzieliśmy się, co to jest noc polarna, dzień polarny i zorza.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy zawody psich zaprzęgów lub kulig.'),
        TropTaskBaseData(content: 'W kręgu rady podsumowaliśmy życie Eskimosów i porównaliśmy z naszym.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy poznać kulturę ludową i jej różnorodność na terenie Polski.'),
        TropTaskBaseData(content: 'Byliśmy w muzeum etnograficznym lub skansenie. Spotkaliśmy się z etnografem lub badaczem kultury.'),
        TropTaskBaseData(content: 'Przenieśliśmy się w czasie, dzięki czemu uczestniczyliśmy w życiu wioski sprzed stu lat. To pomogło nam poznać naszą kulturę.'),
        TropTaskBaseData(content: 'Założyliśmy zuchowy zespół pieśni i tańca. Poznaliśmy kilka pieśni ludowych oraz najbardziej znane polskie tańce.'),
        TropTaskBaseData(content: 'Ułożyliśmy drzewa genealogiczne naszych rodzin z zaznaczeniem, kto skąd pochodzi.'),
        TropTaskBaseData(content: 'Wykonaliśmy ludowe rękodzieło (wycinanki, haft, malunki, wyplatanki, pająki, ręczniki ludowe, ceramikę).'),
        TropTaskBaseData(content: 'Uczestniczyliśmy w obchodach ludowego święta lub prezentacji ludowego zwyczaju (sobótka, dożynki, kolędnicy) zgodnie z tradycją naszego regionu.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy festiwal kultury ludowej (tańce, śpiewy, gawędy, obrazy, rzeźby, hafty, wycinanki). Zaprosiliśmy do uczestnictwa w nim innych wykonawców i publiczność.'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy o wstąpieniu do szczepu indiańskiego. Wykonaliśmy odpowiednie stroje.'),
        TropTaskBaseData(content: 'Zbudowaliśmy wioskę indiańską, w której każda szóstka miała swoje tipi.'),
        TropTaskBaseData(content: 'Wykonaliśmy indiańskie totemy szóstek oraz inne elementy zdobnictwa.'),
        TropTaskBaseData(content: 'Poznaliśmy prawa i zwyczaje panujące w indiańskiej wiosce.'),
        TropTaskBaseData(content: 'Zasiadaliśmy w indiańskim kręgu rady, gdzie radziliśmy na bieżące tematy wioski.'),
        TropTaskBaseData(content: 'Tropiliśmy zwierzęta i poznaliśmy ich zwyczaje. Nauczyliśmy się żyć w zgodzie z przyrodą.'),
        TropTaskBaseData(content: 'Po przejściu prób braterstwa zorganizowaliśmy uroczystość nadania indiańskich imion.'),
        TropTaskBaseData(content: 'Urządziliśmy ucztę przyjaźni, na którą zaprosiliśmy wodzów z sąsiednich wiosek, podpisaliśmy pakt przyjaźni, zakopaliśmy topór wojenny.'),
        TropTaskBaseData(content: 'Urządziliśmy indiańskie zawody sprawności i zręczności. Uczyliśmy się strzelać z łuku i bezszelestnie się poruszać.'),
        TropTaskBaseData(content: 'Wykonaliśmy pożyteczne prace na rzecz naszej indiańskiej wioski.'),
        TropTaskBaseData(content: 'Na podsumowanie indiańskiej przygody zorganizowaliśmy Święto Słońca.'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzję o podróży do Japonii.'),
        TropTaskBaseData(content: 'Wzięliśmy udział w ceremonii parzenia herbaty.'),
        TropTaskBaseData(content: 'Uczestniczyliśmy w treningu karate.'),
        TropTaskBaseData(content: 'Byliśmy w szkole samurajów, gdzie poznaliśmy ich kodeks.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy japoński teatr cieni. Każda szóstka zaprezentowała swoją opowieść.'),
        TropTaskBaseData(content: 'Nauczyliśmy się origami – sztuki składania papieru. Poznaliśmy mit o tysiącu żurawi.'),
        TropTaskBaseData(content: 'Poznaliśmy kilka japońskich słów i nauczyliśmy się pisać niektóre znaki alfabetu japońskiego.'),
        TropTaskBaseData(content: 'Widzieliśmy filmy wyprodukowane w Japonii (np. przez studio Ghibi). Dowiedzieliśmy się, czym jest kultura anime.'),
        TropTaskBaseData(content: 'Poznaliśmy zasady japońskiego dobrego wychowania, staraliśmy się ich przestrzegać.'),
        TropTaskBaseData(content: 'Bawiliśmy się w tradycyjne japońskie gry i zabawy.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, dlaczego Japonię nazywa się „krajem kwitnącej wiśni”.'),
        TropTaskBaseData(content: 'Na podsumowanie wizyty w Japonii zorganizowaliśmy tradycyjną ucztę, byliśmy ubrani w kimona, jedliśmy pałeczkami.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy przenieść się w czasy pierwotne. Bawiliśmy się w jaskiniowców. Urządziliśmy swoją jaskinię.'),
        TropTaskBaseData(content: 'Wspólnie ustaliliśmy zasady panujące w jaskini. Wszyscy ich przestrzegaliśmy.'),
        TropTaskBaseData(content: 'Byliśmy w muzeum lub skansenie archeologicznym. Rozmawialiśmy z badaczem dawnych epok.'),
        TropTaskBaseData(content: 'Zdobywaliśmy pożywienie, tropiliśmy zwierzęta i zbieraliśmy jadalne rośliny. Polowaliśmy na mamuta lub inną zwierzynę.'),
        TropTaskBaseData(content: 'Upiekliśmy na ogniu naszą ulubioną potrawę.'),
        TropTaskBaseData(content: 'Odwiedziliśmy inne plemię jaskiniowców.'),
        TropTaskBaseData(content: 'Porozumiewaliśmy się bez użycia mowy.'),
        TropTaskBaseData(content: 'Wymyśliliśmy własne pismo obrazkowe, którym uzupełniamy kroniki szóstek.'),
        TropTaskBaseData(content: 'Lepiliśmy naczynia z gliny. Wykonaliśmy naszyjniki z kości i kamyków.'),
        TropTaskBaseData(content: 'Pod okiem wodza plemienia kształciliśmy się w obcowaniu z przyrodą i doskonaleniu sprawności fizycznej. Nauczyliśmy się strzelać z procy i rzucać dzidą.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wystawę rysunków jaskiniowych.'),
        TropTaskBaseData(content: 'Na koniec zorganizowaliśmy obrzęd związany z porą roku lub zjawiskiem przyrodniczym.'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzję o wyprawie na Dziki Zachód.'),
        TropTaskBaseData(content: 'Pracując szóstkami, zbudowaliśmy miasteczko na Dzikim Zachodzie, w którym znajdowały się biuro szeryfa, sąd, poczta, bank i saloon.'),
        TropTaskBaseData(content: 'Wykonaliśmy kapelusze, pasy, lassa, ostrogi lub inne elementy kowbojskiego ubioru.'),
        TropTaskBaseData(content: 'Zrobiliśmy mapę naszej osady i okolicy. Otrzymaliśmy akt nadania ziemi.'),
        TropTaskBaseData(content: 'Zaprzyjaźniliśmy się z mieszkańcami pobliskiej wioski indiańskiej.'),
        TropTaskBaseData(content: 'Hodowaliśmy bydło. Dowiedzieliśmy się, jak pielęgnować bydło i konie. Rzucaliśmy lassem.'),
        TropTaskBaseData(content: 'Bawiliśmy się w poszukiwaczy złota.'),
        TropTaskBaseData(content: 'Pomagaliśmy szeryfowi w ujęciu rabusiów i doprowadzeniu ich przed sąd.'),
        TropTaskBaseData(content: 'Braliśmy udział w zabawie tanecznej przy muzyce country.'),
        TropTaskBaseData(content: 'Byliśmy z wizytą w stadninie koni.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyścigi dyliżansów.'),
        TropTaskBaseData(content: 'Urządziliśmy święto naszego miasta, zaprosiliśmy na nie przyjaciół (Indian, gubernatora).'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady zdecydowaliśmy, że wyruszymy w podróż w nieznane.'),
        TropTaskBaseData(content: 'Ułożyliśmy kodeks odkrywcy, podpisaliśmy się pod nim i powiesiliśmy go w zuchówce.'),
        TropTaskBaseData(content: 'Prowadziliśmy dziennik podróży.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, czym jest azymut. Nauczyliśmy się posługiwać kompasem/busolą i mapą.'),
        TropTaskBaseData(content: 'Zakopaliśmy skarb i sporządziliśmy mapę, która pomoże w jego odnalezieniu.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy spotkanie, na które zaprosiliśmy podróżników.'),
        TropTaskBaseData(content: 'Poznaliśmy historie Krzysztofa Kolumba, Ferdynanda Magellana, Vasco da Gamy lub Marco Polo. Zainscenizowaliśmy jedno z ich odkryć.'),
        TropTaskBaseData(content: 'Nauczyliśmy się kilku węzłów, niezbędnych podczas podróży żaglowcem.'),
        TropTaskBaseData(content: 'Odbyliśmy podróż szlakiem jednego z wielkich odkrywców. Wcześniej zaplanowaliśmy ją, uwzględniając trudne warunki życia i zdobywania pożywienia.'),
        TropTaskBaseData(content: 'Przywitaliśmy tubylców spotkanych podczas podróży. Poznaliśmy ich zwyczaje i uszanowaliśmy ich teren.'),
        TropTaskBaseData(content: 'Poznaliśmy klimat odkrytego lądu i zbadaliśmy, czym się różni od naszego.'),
        TropTaskBaseData(content: 'Podsumowaliśmy nasze odkrycia. Potrafimy wskazać na mapie poznane kontynenty i oceany.'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'Dostaliśmy zaproszenie od Wielkiego Rycerza. W kręgu rady zdecydowaliśmy, że podejmiemy się wyzwania, jakim jest rycerskie życie.'),
        TropTaskBaseData(content: 'Jako giermkowie służyliśmy Wielkiemu Rycerzowi. Pod jego okiem nauczyliśmy się postępować po rycersku, strzelać z łuku i walczyć mieczem.'),
        TropTaskBaseData(content: 'Ułożyliśmy kodeks rycerski.'),
        TropTaskBaseData(content: 'Zostaliśmy pasowani na rycerzy.'),
        TropTaskBaseData(content: 'Urządziliśmy igrce i występy trubadurów.'),
        TropTaskBaseData(content: 'Uczestniczyliśmy w wielkich łowach.'),
        TropTaskBaseData(content: 'Każda szóstka wzięła udział w turnieju rycerskim.'),
        TropTaskBaseData(content: 'Uczestniczyliśmy w inscenizacji bitwy pod Grunwaldem lub innej bitwy, w której brali udział rycerze.'),
        TropTaskBaseData(content: 'Poznaliśmy kilka legend o znanych rycerzach. Dowiedzieliśmy się, kim byli Zawisza Czarny oraz św. Jerzy.'),
        TropTaskBaseData(content: 'Jako rycerze pomagaliśmy słabszym.'),
        TropTaskBaseData(content: 'Byliśmy w muzeum historycznym, w zamku lub obejrzeliśmy stare mury.'),
        TropTaskBaseData(content: 'Spotkaliśmy się z rycerzami Okrągłego Stołu lub rycerzami Karola Wielkiego.'),
        TropTaskBaseData(content: 'Na podsumowanie naszej rycerskiej przygody zorganizowaliśmy na zamku bal i ucztę, na które zaprosiliśmy gości.'),
      ],
  ...
  TropBaseData(
      ...
      tasks: [
        ...
        TropTaskBaseData(content: 'Zbudowaliśmy słowiańskie grodzisko lub szałas w lesie.'),
        TropTaskBaseData(content: 'Polowaliśmy na niedźwiedzia, tura lub jelenia.'),
        TropTaskBaseData(content: 'Urządziliśmy turniej wojów, podczas którego wykorzystywaliśmy zrobione przez nas szyszaki, tarcze, oszczepy, miecze, łuki i strzały.'),
        TropTaskBaseData(content: 'Urządziliśmy postrzyżyny, na których przyjęliśmy słowiańskie imiona określające nasze charaktery lub nawiązujące do dokonanych przez nas czynów.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę do innych słowiańskich plemion.'),
        TropTaskBaseData(content: 'Trudniliśmy się garncarstwem.'),
        TropTaskBaseData(content: 'Zbieraliśmy zioła i owoce leśne. Suszyliśmy jabłka i gruszki w popiele. W szóstkach przygotowaliśmy potrawy i napoje z darów lasu.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy wyprawę handlową.'),
        TropTaskBaseData(content: 'Poznaliśmy kilka słowiańskich baśni. Dowiedzieliśmy się, w co wierzyli Słowianie.'),
        TropTaskBaseData(content: 'Na podsumowanie obchodziliśmy Święto Kupały lub topiliśmy marzannę.'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady podjęliśmy decyzję o wstąpieniu do spartańskiej szkoły.'),
        TropTaskBaseData(content: 'Wykonaliśmy stroje spartańskich wojowników.'),
        TropTaskBaseData(content: 'Przeszliśmy różne próby odwagi i wytrzymałości.'),
        TropTaskBaseData(content: 'Odbyliśmy wyprawę pod Termopile.'),
        TropTaskBaseData(content: 'W trosce o naszą sprawność wykonywaliśmy ćwiczenia i uczyliśmy się musztry.'),
        TropTaskBaseData(content: 'Sprawdzając nasze wysiłki, zorganizowaliśmy starożytną olimpiadę z tradycyjnym pięciobojem.'),
      ],
  ...
  TropBaseData(
      ...
      tasks: [
        ...
        TropTaskBaseData(content: 'Wybraliśmy się na wycieczkę do dworku, dworu lub muzeum historycznego.'),
        TropTaskBaseData(content: 'Oglądaliśmy stroje szlacheckie.'),
        TropTaskBaseData(content: 'Poznaliśmy znane postacie szlacheckie.'),
        TropTaskBaseData(content: 'Kształciliśmy się na szlacheckim dworze. Uczyliśmy się szermierki, nakrywania do stołu, dobrych manier, gospodarki i ekonomii, prawa oraz jazdy konnej.'),
        TropTaskBaseData(content: 'Wzięliśmy udział w turnieju o szablę Michała Wołodyjowskiego lub szarfę damy dworu.'),
        TropTaskBaseData(content: 'Wykonaliśmy herby i potrafimy opowiedzieć o ich symbolice. Ułożyliśmy zawołania naszych rodów.'),
        TropTaskBaseData(content: 'Zwołaliśmy sejm. Obradowaliśmy nad najważniejszymi sprawami naszej małej ojczyzny. Wnioski przekazaliśmy włodarzom.'),
        TropTaskBaseData(content: 'Tańczyliśmy poloneza.'),
        TropTaskBaseData(content: 'Obchodziliśmy Dzień Dobrych Manier.'),
        TropTaskBaseData(content: 'Zorganizowaliśmy szlachecki kulig lub przejażdżkę wozami, zakończone wspólnym gotowaniem lub spożywaniem dania kuchni staropolskiej (np. bigosu).'),
      ],
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy zostać wikingami.'),
        TropTaskBaseData(content: 'Zbudowaliśmy wioskę wikingów, wykonaliśmy stroje i ozdoby.'),
        TropTaskBaseData(content: 'Szóstkami uczestniczyliśmy w zawodach drakkarów.'),
        TropTaskBaseData(content: 'Poznaliśmy legendy o Odynie, Thorze i innych bogach Asgardu.'),
        TropTaskBaseData(content: 'Uczyliśmy się pisma runicznego.'),
        TropTaskBaseData(content: 'Wzięliśmy udział w zamorskiej wyprawie handlowej. Przygotowaliśmy towary na wymianę (naczynia z gliny, ozdoby z metalu, haftowane tkaniny).'),
        TropTaskBaseData(content: 'Dbaliśmy o sprawność fizyczną, urządziliśmy zawody zręczności i siły.'),
        TropTaskBaseData(content: 'Zajmowaliśmy się ziołolecznictwem.'),
        TropTaskBaseData(content: 'Urządziliśmy tradycyjną ucztę z tańcami.'),
      ],
      notesForLeaders: 'Dobry trop na kolonię!'
  ...
  TropBaseData(
      ...
      aims: [],
      tasks: [
        TropTaskBaseData(content: 'W kręgu rady postanowiliśmy zostać żakami i wstąpić na uniwersytet.'),
        TropTaskBaseData(content: 'Zdawaliśmy egzaminy wstępne na uniwersytet. Dostaliśmy indeksy.'),
        TropTaskBaseData(content: 'Bawiliśmy się w żaków i profesorów – wykonaliśmy togi, czapki żaków i inne rekwizyty.'),
        TropTaskBaseData(content: 'Dowiedzieliśmy się, gdzie został założony pierwszy w Polsce uniwersytet i kto był jego fundatorem.'),
        TropTaskBaseData(content: 'Uczestniczyliśmy w otrzęsinach.'),
        TropTaskBaseData(content: 'Byliśmy słuchaczami jednego z wydziałów uniwersytetu: astronomii, przyrody, matematyki.'),
        TropTaskBaseData(content: 'Wyszukiwaliśmy informacje w książkach i encyklopediach.'),
        TropTaskBaseData(content: 'Braliśmy udział w juwenaliach.'),
        TropTaskBaseData(content: 'Pisaliśmy gęsim piórem i atramentem. Dowiedzieliśmy się, co to jest kałamarz.'),
        TropTaskBaseData(content: 'Poznaliśmy kilka słów po łacinie.'),
        TropTaskBaseData(content: 'Zarabialiśmy na nasze żakowskie potrzeby (wystawiliśmy przedstawienie o życiu żaków, sprzedawaliśmy nasze majsterki).'),
        TropTaskBaseData(content: 'Byliśmy na wycieczce w dzielnicy uniwersyteckiej, spotkaliśmy się ze studentem.'),
        TropTaskBaseData(content: 'Na koniec otrzymaliśmy dyplom ukończenia uniwersytetu i tytuł bakałarza.'),
      ],
