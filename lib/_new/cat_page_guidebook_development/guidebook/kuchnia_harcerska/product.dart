...
class Product{
  ...
  static const Product cebula =  Product('Cebula', 'kuch_onion', 30,  1.4,  6.9,  0.4, ['E', 'K'], [Subst.S], unitManager: UnitManager(defUnit: Unit.item, gInItem: 200));
...
//public static final Product cwikla =  Product('Ćwikła', 0, 0,  41f,  1.6f,  10.2f,  0.1f, ['B9', 'E', 'K'}, [Subst.P, K, Mn]});
  ...
  static const Product koncentrat_pomidorowy = Product('Koncentrat pomidorowy', 'kuch_tomato_sauce',  92, 5.6, 16.7, 1.5, ['C', 'E', 'B1', 'B2', 'B3', 'B6', 'K'], [], unitManager: UnitManager(defUnit: Unit.ml, gInMl: 1.2));
  ...
  static const Product ziemniaki = Product('Ziemniaki', 'kuch_potatoes',  85, 1.9, 20.5, 0.1, ['B1', 'B2', 'B3', 'B5', 'B6', 'C', 'E', 'K'], [Subst.K]);
  ...
  static const List<Product> all = [
    ...
    chrupki_kukurydziane, chrzan, coca_cola, cukier, cukierki_krowki, cukinia,
    cytryna, czekolada_biala, czekolada_gorzka, czekolada_mleczna, czosnek,
//cwikla,
    daktyle_suszone, fasola_biala, figi_suszone, grejpfrut,
    ...
    kasza_manna, kaszka_dziecieca, kawa, ketchup, kielbasa_krakowska, kielbasa_parowkowa, kielbasa_podwawelska,
    koncentrat_pomidorowy, kukurydza_puszka, majeranek, makaron, maliny, mandarynki, marchew, margaryna, maslo_ekstra, maka_przenna,
    melon, mielonka, migdaly, mleko_spozywcze_1_5_pro, mleko_spozywcze_2_0_pro, mleko_spozywcze_3_2_pro, mleko_zageszczone,
    morele_suszone, musztarda, natka_pietruszki, nektarynka, ocet, olej_rzepakowy, oliwa_z_oliwek,
    oliwki, orzechy_laskowe, orzechy_nerkowca, orzechy_pistacjowe, orzechy_wloskie, orzeszki_ziemne, paluszki, papryka_czerwona,
    parowki, pasztet_z_drobiu, pestki_dyni, pieczarka, pieprz, piersi_indycze, piersi_z_kurczaka,
    ...
    tunczyk_w_oleju, winogrona, ziemniaki
  ];
