...
List<ItemData> items = [
  ...
  ItemData(
      [
        const Graphics('brzoza_rawpixel', auth_rawpixel),
      ],
      const Graphics('brzoza', null),
      'Brzoza',
      ...
      backgroundKora: const Graphics('brzoza', '$auth_unsplash @worldsbetweenlines')
  ),

  ItemData(
      [
        const Graphics('buk_rawpixel', auth_rawpixel),
        //Graphics('buk_1_macrovector', auth_macrovector)
      ],
      const Graphics('buk', null),
      'Buk',
      ...
      backgroundKora: const Graphics('buk', auth_vtinvasives)
    //background_kora: Graphics('buk', auth_unsplash + ' @grynykha')
  ),

  ItemData(
      [
        const Graphics('cis_wikipedia', auth_wikipedia),
        //Graphics('buk_1_macrovector', auth_macrovector)
      ],
      const Graphics('cis', 'tygodniksanocki.pl'),
      'Cis',
  ...
  ItemData(
      [
        const Graphics('dab_opencaching_pl', auth_opencaching_pl),
  ...
  ItemData(
      [
        const Graphics('dab_blotny', null)
      ],
      const Graphics('dab_blotny', auth_bearfotos),
      'Dąb błotny',
  ...
  ItemData(
      [
        const Graphics('glog_rawpixel', auth_rawpixel)
      ],
      const Graphics('glog', null),
      'Głóg',
  ...
  ItemData(
      [
        const Graphics('grab_rawpixel', auth_rawpixel)
      ],
      const Graphics('grab', null),
      'Grab',
  ...
  ItemData(
      [
        const Graphics('grusza_rawpixel', auth_rawpixel),
      ],
      const Graphics('grusza', null),
      'Grusza',
      ...
      ['Kora spękana'],
      cieplo: null, zar: null, plomien: null, czas: null,
      backgroundKora: const Graphics('grusza', '')
  ),

  ItemData(
      [
        const Graphics('jarzebina_rawpixel', auth_rawpixel),
        const Graphics('jarzebina_wikipedia', auth_wikipedia),
  ...
  ItemData(
      [
        const Graphics('jesion_insectimages', auth_zelimir_borzan)
      ],
      const Graphics('jesion', null),
      'Jesion',
  ...
  ItemData(
      [
        const Graphics('kasztan_wikipedia', auth_wikipedia),
      ...
      const Graphics('kasztanowiec', null),
      'Kasztan',
  ...
  ItemData(
      [
        const Graphics('klon_jawor_invasive_137904', auth_zelimir_borzan),
      ],
      const Graphics('klon_jawor', 'J. Kuczyńska'),
      'Klon jawor',
  ...
  ItemData(
      [
        const Graphics('klon_zwyczajny_wikipedia', auth_wikipedia),
      ],
      const Graphics('klon_zwyczajny', null),
      'Klon zwyczajny',
  ...
  ItemData(
      [
        const Graphics('leszczyna_wikipedia', auth_wikipedia),
      ],
      const Graphics('leszczyna', null),
      'Leszczyna',
      ...
      [],
      cieplo: null, zar: null, plomien: null, czas: null,
      backgroundKora: const Graphics('leszczyna', '')
  ),

  ItemData(
      [
        const Graphics('lipa_zelimir_borzan', auth_zelimir_borzan),
        //Graphics('buk_1_macrovector', auth_macrovector)
      ],
      const Graphics('lipa', ''),
      'Lipa',
  ...
  ItemData(
      [
        const Graphics('modrzew_weedimages', auth_zelimir_borzan),
        const Graphics('modrzew_wikipedia', auth_wikipedia)
      ],
      const Graphics('modrzew', null),
      'Modrzew',
  ...
  ItemData(
      [
        const Graphics('olcha_rawpixel', auth_rawpixel)
      ],
      const Graphics('olcha', null),
      'Olcha',
  ...
  ItemData(
      [
        const Graphics('sosna_rawpixel', auth_rawpixel),
      ...
      cieplo: 3, zar: 1, plomien: 0, czas: 1,
      backgroundKora: const Graphics('sosna', '')
  ),

  ItemData(
      [
        const Graphics('swierk_rawpixel', auth_rawpixel,)
      ],
      const Graphics('swierk', null),
      'Świerk',
  ...
  ItemData(
      [
        const Graphics('sliwa_rawpixel', auth_rawpixel,)
      ],
      const Graphics('sliwa', 'naszekrzewy.pl'),
      'Śliwa',
      ...
      ['Owoce jadalne'],
      cieplo: null, zar: null, plomien: null, czas: null,
    backgroundKora: const Graphics('sliwa', 'fajnyogrod.pl'),
  ),

  ItemData(
      [
        const Graphics('truskawka_rawpixel', auth_rawpixel),
      ],
      const Graphics('truskawka', null),
      'Truskawka',
  ...
  ItemData(
      [
        const Graphics('wiaz_rawpixel', auth_rawpixel)
      ],
      const Graphics('wiaz', null),
      'Wiąz',
  ...
  ItemData(
      [
        const Graphics('wierzba_rawpixel', auth_rawpixel),
        //Graphics('wierzba_1_macrovector', auth_macrovector)
      ],
      const Graphics('wierzba', null),
      'Wierzba',
  ...
  ItemData(
      [
        const Graphics('wisnia_rawpixel', auth_rawpixel),
      ],
      const Graphics('wisnia', null),
      'Wiśnia',
